...
class TestIncidentFlow:
    ...
    def test_circuit_breaker_triggers(self):
        ...
        # is_available triggers auto-transition to half-open
        assert cb.is_available
        assert cb.state == CircuitState.HALF_OPEN

        cb.record_success()
        # May need more successes depending on success_threshold
...
class TestDeliveryPipeline:
    ...
    def test_canary_rollout(self):
        ...
        assert rollout.current_step.name == "canary-10"
...
class TestChaosExperiment:
    ...
    def test_fault_injection(self):
        ...
        experiment = ChaosExperiment(
            ...
            faults=[
                Fault(
                    fault_type=FaultType.LLM_LATENCY,
                    target="llm-call",
