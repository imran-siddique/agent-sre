...
class TestFault:
    def test_tool_timeout(self) -> None:
        ...
        assert f.fault_type == FaultType.TOOL_TIMEOUT
    ...
    def test_llm_latency(self) -> None:
        ...
        assert f.fault_type == FaultType.LLM_LATENCY
    ...
    def test_to_dict(self) -> None:
        ...
        d = f.to_dict()
        assert d["fault_type"] == "tool_timeout"
...
class TestChaosExperiment:
    ...
    def test_resilience_score(self) -> None:
        ...
        assert score.fault_tolerance > 0
        assert score.degradation_percent > 0
